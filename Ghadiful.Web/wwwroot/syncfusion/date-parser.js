...
var parser = CustomParserBase;
var BSParser = BSParser;
 ...
 * @private
 */
var CustomDateParser = /** @class */ (function () {
    function CustomDateParser() {
    }
    /**
     ...
     * @returns {Function} ?
     */
    CustomDateParser.dateParser = function (culture, option, cldr) {
        var _this = this;
        ...
        if (isUndefined(resPattern)) {
            ...
            parseOptions = { isBS: base.bsRegex.test(option.calendar), pattern: resPattern, evalposition: {}, culture: culture };
                    ...
                    case 'f':
                        ...
                        if ((char === 'M' || char === 'L') && len > 2) {
                            ...
                            if (isBlazor()) {
                                ...
                                // eslint-disable-next-line
                                monthData = dependable.dateObject[months][standalone][base.monthIndex[len]];
                            }
                            // eslint-disable-next-line
        ...
        return function (value) {
            ...
            if (parseOptions.isBS) {
                ...
                if (!tYear || !tMonth || !tDate || is2DigitYear) {
                    dobj = BSParser.getBSDate(new Date());
                }
                if (is2DigitYear) {
                    tYear = parseInt((dobj.year + '').slice(0, 2) + ystrig, 10);
                }
                // tslint:disable-next-line
                var dateObject = BSParser.toGregorian(tYear || dobj.year, tMonth || dobj.month, tDate || dobj.date);
     ...
     * @returns {Date} ?
     */
    CustomDateParser.getDateObject = function (options, value) {
     ...
     * @returns {DateParts} ?
     */
    CustomDateParser.internalDateParse = function (value, parseOptions, num) {
            ...
            for (var _i = 0, props_1 = props; _i < props_1.length; _i++) {
                ...
                if (curObject.isNumber) {
                    ...
                    if (prop === 'timeZone' && !isUndefined(matchString)) {
                        ...
                        // eslint-disable-next-line
                        matchString = ((prop === 'month') && (!parseOptions.isBS) && (parseOptions.culture === 'en' || parseOptions.culture === 'en-GB' || parseOptions.culture === 'en-US'))
     ...
     * @returns {number} ?
     */
    CustomDateParser.internalNumberParser = function (value, option) {
     ...
     * @returns {string} ?
     */
    CustomDateParser.parseTimeZoneRegx = function (hourFormat, tZone, nRegex) {
     ...
     * @returns {number} ?
     */
    CustomDateParser.getZoneValue = function (flag, val1, val2, num) {
