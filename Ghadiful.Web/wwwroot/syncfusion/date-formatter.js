...
//var HijriParser = ej.base.HijriParser;
...
var CustomDateFormat = /** @class */ (function () {
     ...
     * @returns {Function} ?
     */
    CustomDateFormat.dateFormat = function (culture, option, cldr) {
        var _this = this;
        var dependable = base.getDependables(cldr, culture, option.calendar);
        var numObject = getValue('parserObject.numbers', dependable);
        var dateObject = dependable.dateObject;
        var formatOptions = { isBS: base.bsRegex.test(option.calendar) };
     ...
     * @returns {string} ?
     */
    CustomDateFormat.intDateFormatter = function (value, options) {
        var pattern = options.pattern;
        var ret = '';
        var matches = pattern.match(base.dateParseRegex);
        var dObject = this.getCurrentDateValue(value, options.isBS);
    ...
    CustomDateFormat.getCurrentDateValue = function (value, isBS) {
        if (isBS) {
            return BSParser.getBSDate(value);
        }
     ...
     * @returns {string} ?
     */
    CustomDateFormat.checkTwodigitNumber = function (val, len) {
        var ret = val + '';
     ...
     * @private
     */
    CustomDateFormat.getTimeZoneValue = function (tVal, pattern) {
        var _this = this;
