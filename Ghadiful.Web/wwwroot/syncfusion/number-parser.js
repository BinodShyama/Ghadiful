 ...
 * @private
 */
var CustomNumberParser = /** @class */ (function () {
    function CustomNumberParser() {
    }
    /**
     ...
     * @returns {Function} ?
     */
    CustomNumberParser.numberParser = function (culture, option, cldr) {
        var _this = this;
     ...
     * @returns {number} ?
     */
    CustomNumberParser.getParsedNumber = function (value, options, numOptions) {
        var isNegative;
        var isPercent;
        var tempValue;
        var lead;
    ...
    CustomNumberParser.convertMaxFracDigits = function (value, options, ret, isNegative) {
